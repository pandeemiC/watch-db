export const faqData = [
  {
    ...
    answer:
      "I have used TMDB API in order to fetch the movie data as well as respective image and details such as ratings, posters, cast information and more. Appwrite is also used for search analytics.",
  },
  {
    question: "What kind of features does the site have?",
    answer:
      "The site currently can view the searched movie fetched from the API, view details when clicked on the respective movie card, YouTube and Website navigation through movie details, lightbox feature that lets the user view images in a modern fashion within movie details and simple key listeners.",
  },
  {
